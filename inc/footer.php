      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="social-links">
               ...
               <li><a target ="_blank" href="https://www.instagram.com/doldolanan.id?igsh=MWNvbDFvMmp5OXBpcg=="><i class="fa fa-instagram"></i></a></li>
               <li><a target ="_blank" href="doldolananjepara@gmail.com"><i class="fa fa-google-plus"></i></a></li>
